...
export default function ContextMenu({
    ...
    const menuItems = [
        ...
        { divider: true },
        { icon: isStarred ? StarOff : Star, label: isStarred ? "Unstar" : "Star", action: onStar, show: !file.is_shared || file.can_manage },
        ...
        { icon: Share2, label: file.type === "folder" ? "Manage access" : "Share", action: onShare, show: file.type === "folder" ? file.can_manage : file.can_share_public },
        { divider: true },
